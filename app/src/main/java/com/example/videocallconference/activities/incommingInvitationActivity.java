...
public class incommingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            textFirstChar.setText(firstName.substring(0,1)+lastname.substring(0,1));
        ...
        ImageView imageAcceptInvitation = findViewById(R.id.imageAcceptInviationIncomming);
        ...
        ImageView imageRejectInvitation = findViewById(R.id.imageRejectInviationIncomming);
