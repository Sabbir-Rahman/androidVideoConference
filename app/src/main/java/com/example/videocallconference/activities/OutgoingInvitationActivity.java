...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textFirstChar = findViewById(R.id.textFirstCharInviation);
        TextView textUserName = findViewById(R.id.textUserNameInviation);
        TextView textEmail = findViewById(R.id.textEmailInvitation);
