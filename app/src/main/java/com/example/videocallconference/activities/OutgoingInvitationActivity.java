...
import com.example.videocallconference.network.ApiClient;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textFirstChar = findViewById(R.id.textFirstCharInviation);
        textUserName = findViewById(R.id.textUserNameInviation);
        textEmail = findViewById(R.id.textEmailInvitation);

        User user = (User) getIntent().getSerializableExtra("user");
        if (user != null) {
            textFirstChar.setText(user.firstName.substring(0, 1) + user.lastName.substring(0, 1));
            textUserName.setText(String.format("%s %s", user.firstName, user.lastName));
            textEmail.setText(user.email);
        }

        ImageView imageRejectInvitation = findViewById(R.id.imageRejectOutgoing);
    ...
    private void initiateMeeting(String meetingType, String receiverToken, ArrayList<User> receivers) {
        try {
            ...
            meetingRoom =
                    preferenceManager.getString(Constants.KEY_FIRST_NAME) + "_" +
